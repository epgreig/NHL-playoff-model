...
# Keep features with MDA> and MDG>
...
# Remove features with MDA<1e-03 and MDG<0.4
dStats_clas4 <- dStats_clas3[!dStats_clas3%in%c('dTime_Led')]
...
```{r}
# Create a set of less than features with most predictive power
#huge_model_c4 <- suppressWarnings(randomForest(`Home_Won` ~ ., data=dfc4, ntree=1000000, mtry=1, nodesize=60, importance=TRUE))
#print(huge_model_c4$importance)

# Keep features with MDG>1
dStats_clas5 <- c('dCF.60_55', 'dGF._55', 'dxGF._55', 'dGF._all', 'dGA.60_all', 'dxGF._all', 'dxBerg')
dfc5 <- dfc4[,c('Home_Won', dStats_clas5)]
```
