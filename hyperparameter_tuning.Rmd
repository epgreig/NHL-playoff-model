...
hyper_params <- function(data, mtrys, nodesizes, ntrees=4000) {
...
# Grids attempted:
# hyper_params(df, mtrys=1:25, nodesizes=1:25)
# hyper_params(df, mtrys=1:15, nodesizes=16:35)
# hyper_params(df, mtrys=1:8, nodesizes=28:60)
# hyper_params(df, mtrys=2:8, nodesizes=50:69)
# hyper_params(df, mtrys=2:8, nodesizes=50:59, ntrees=6000)
# hyper_params(df, mtrys=2:8, nodesizes=55:65, ntrees=10000)
...
```{r}
cv_rf_class(df, nfolds=10, nruns=16, mtry=6, nodesize=60)
# BENCHMARK
# Log Loss: 0.67 (sd 0.10)
# Accuracy: 63% (sd 0.12)
