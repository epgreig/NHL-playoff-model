...
cv_rf_reg <- function(dataset, nfolds=10, nruns=32, ntrees=4000, mtry=floor(ncol(df)/3), nodesize=5) {
  set.seed(0)
  n <- nrow(dataset)
  results <- matrix(nrow=nruns, ncol=4)
...
cv_rf_reg_symm <- function(dataset, nfolds=10, nruns=32, ntrees=4000, mtry=floor(ncol(df)/3), nodesize=5) {
  set.seed(0)
  n <- nrow(dataset)
  results <- matrix(nrow=nruns, ncol=4)
