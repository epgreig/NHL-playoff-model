...
predict_matchup(home_team, away_team) {
  home_stats <- playoff_teams_2018[playoff_teams_2018$Team==home_team,dStats]
  away_stats <- playoff_teams_2018[playoff_teams_2018$Team==away_team,dStats]
  ...
  for (i in 1:length(dStats)) {
    ...
    std_diffs[dStat] <- (raw_diffs[dStat]-center)/scale
  }
}
