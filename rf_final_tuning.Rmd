...
# Grids attempted:
#rf_grid(df_5, mtrys=1:2, nodesizes=20:100, ntrees=10000)
rf_grid(df_5, mtrys=1, nodesizes=70:95, ntrees=20000)
...
cv_rf_reg(df_4, nfolds=11, nruns=32, mtry=1, nodesize=60, ntrees=4000)
# 7 FEATURES
# Log Loss: 0.633 (sd 0.08)
# Accuracy: 66%

cv_rf_reg(df_5, nfolds=11, nruns=32, mtry=1, nodesize=45, ntrees=20000)
# 4 FEATURES
# Log Loss: 0.632 (sd 0.08)
# Accuracy: 67%
```
